...
#input.file="~/NLAAA149189_summary.txt" # <- useful if you want to specify a summary to run manually
...
rst[is.na(rst)] <- 0
rst <- rst[order(as.numeric(rst$channel),method = "radix"),]
map <- map[order(as.numeric(map$channel),method = "radix"),]
