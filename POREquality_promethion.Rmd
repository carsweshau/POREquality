...
opts_chunk$set(fig.width=12, fig.height=8, include=FALSE, echo=FALSE, warning=FALSE, message=FALSE, fig.path='images/', dev=c('png', 'pdf'))
```
...
#input.file="~/BC08_seq_sum.txt" # <- useful if you want to specify a summary to run manually
...
# seq_dt <- seq_dt[sample(.N,1000000)]
...
```{r channel_activity}
#seq_dt <- seq_dt[sample(.N,100000)] # Subsampling for PromethION runs
